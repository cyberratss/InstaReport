...
def unlock ():#line:147
    ...
    if (OOO00O0OOO0OO0O0O =="@Cyber_Rats"):#line:150
        print_success ("Successfully unlocked the tool!\n\n")#line:151
        starting_bot ()#line:152
        database ()#line:153
    elif (OOO00O0OOO0OO0O0O =="1"):#line:154
        print_success ("Send #instareport in telegram group @CyberRatsChat to get the code\n\n")#line:155
        time .sleep (3 )#line:156
        webbrowser .open ('http://t.me/CyberRatsChat')#line:157
        time .sleep (1 )#line:158
        unlock ()#line:159
    else :#line:160
        print ('\nINVALID CODE\n\nHow To Get Code\nGo to t.me/CyberRatsChat\nSend #instareport')#line:161
